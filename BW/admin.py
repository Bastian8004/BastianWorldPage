...
from BW.models import Services, Qualifications, Contakt, Start, BlogS, BlogBW, PostS, PostBW, KomentarzBW, KomentarzS
...
admin.site.register(KomentarzBW)
admin.site.register(KomentarzS)
