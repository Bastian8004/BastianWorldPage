...
urlpatterns = [
    ...
    path('about%us',views.qualifications, name='about_us'),
    path('about%us/new/', views.qualifications_new, name='about_us_new'),
    path('about%us/<int:pk>/edit/', views.qualifications_edit, name='about_us_edit'),
    path('about%us/<int:pk>/delete/', views.qualifications_delete, name='about_us_delete'),
